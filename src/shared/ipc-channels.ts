...
export const STAFF_CHANNELS = {
  ...
  VERIFY_ACTION_PIN: 'staff:verifyActionPin',
...
export const AUTH_CHANNELS = {
  ...
  CHECK: 'auth:check',
  TOUCH: 'auth:touch',
  SET_TIMEOUT: 'auth:setTimeout',
} as const;

export const APP_CHANNELS = {
  UNLOCK: 'app:unlock',
  IS_LOCKED: 'app:isLocked',
} as const;
...
export const BACKUP_CHANNELS = {
  ...
  GET_SETTINGS: 'backup:getSettings',
  UPDATE_SETTINGS: 'backup:updateSettings',
  GET_HEALTH: 'backup:getHealth',
} as const;
...
export const INSTRUCTION_CHANNELS = {
  ...
  GET_ALL_INSTRUCTION_TEMPLATES: 'instruction:getAllInstructionTemplates',
  UPDATE_INSTRUCTION_TEMPLATE: 'instruction:updateInstructionTemplate',
} as const;
