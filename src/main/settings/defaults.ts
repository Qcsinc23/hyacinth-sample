...
> = {
  ...
  backupDirectory: {
    ...
    description: 'Directory where local database backups are written',
    type: 'string',
  },
  backupCompress: {
    label: 'Compress Backups',
    description: 'Store backups as gzip-compressed archives',
    type: 'boolean',
  },
  backupVerify: {
    label: 'Verify Backups',
    description: 'Run integrity verification after each backup',
    type: 'boolean',
  },
  lastBackup: {
    label: 'Last Backup',
